...
#if defined(NDEBUG)
# error "BitcoinRocket cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitcoinRocket Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BitcoinRocket also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BitcoinRocket also requires low S in sigs
