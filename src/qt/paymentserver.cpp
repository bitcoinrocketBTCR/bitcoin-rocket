...
const QString BITCOIN_IPC_PREFIX("bitcoinrocket:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bitcoinrocket-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitcoinrocket-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitcoinrocket-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bitcoinrocket: links
...
//
// OSX-specific way of handling bitcoinrocket: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bitcoinrocket: URIs
