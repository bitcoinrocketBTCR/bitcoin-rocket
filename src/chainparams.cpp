...
public:
    CMainParams() {
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("bitcoinrocket.online", "node1.bitcoinrocket.online"));
        vSeeds.push_back(CDNSSeedData("n2.bitcoinrocket.online", "node2.bitcoinrocket.online"));
